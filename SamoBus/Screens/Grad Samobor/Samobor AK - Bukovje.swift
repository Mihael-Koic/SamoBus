...
struct PDFViewer19: UIViewRepresentable {
...
struct Samobor_AK___Bukovje: View {
    // Change the name and extension to match your PDF file
    let pdfURL = Bundle.main.url(forResource: "s8", withExtension: "pdf")!
