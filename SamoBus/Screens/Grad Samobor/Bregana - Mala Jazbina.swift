...
struct PDFViewer23: UIViewRepresentable {
...
struct Bregana___Mala_Jazbina: View {
    // Change the name and extension to match your PDF file
    let pdfURL = Bundle.main.url(forResource: "s12", withExtension: "pdf")!
