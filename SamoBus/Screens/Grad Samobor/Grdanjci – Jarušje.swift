...
struct PDFViewer26: UIViewRepresentable {
...
struct Grdanjci___Jarus_je: View {
    // Change the name and extension to match your PDF file
    let pdfURL = Bundle.main.url(forResource: "s15", withExtension: "pdf")!
