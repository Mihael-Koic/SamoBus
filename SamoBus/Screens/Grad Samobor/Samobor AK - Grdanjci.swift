...
struct PDFViewer24: UIViewRepresentable {
...
struct Samobor_AK___Grdanjci: View {
    // Change the name and extension to match your PDF file
    let pdfURL = Bundle.main.url(forResource: "s13", withExtension: "pdf")!
