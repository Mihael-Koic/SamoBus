...
struct PDFViewer8: UIViewRepresentable {
...
struct Samobor_Jastrebarsko: View {
    // Change the name and extension to match your PDF file
    let pdfURL = Bundle.main.url(forResource: "513", withExtension: "pdf")!
