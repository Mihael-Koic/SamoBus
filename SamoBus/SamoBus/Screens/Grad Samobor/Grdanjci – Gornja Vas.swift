...
struct PDFViewer25: UIViewRepresentable {
...
struct Grdanjci___Gornja_Vas: View {
    // Change the name and extension to match your PDF file
    let pdfURL = Bundle.main.url(forResource: "s14", withExtension: "pdf")!
