//
//  S1-Ak-Samobor-Kol.-Naselje.swift
//  SamoBus
//
...
struct PDFViewer12: UIViewRepresentable {
...
struct S1_Ak_Samobor_Kol__Naselje: View {
    // Change the name and extension to match your PDF file
    let pdfURL = Bundle.main.url(forResource: "s1", withExtension: "pdf")!
