...
struct PDFViewer28: UIViewRepresentable {
...
struct Samobor_AK___Slani_Dol: View {
    // Change the name and extension to match your PDF file
    let pdfURL = Bundle.main.url(forResource: "s17", withExtension: "pdf")!
